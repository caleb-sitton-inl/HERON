...
def plot_solution(m):
  ...
  axs[2].set_ylabel(f'Electricity\n(kW)')
  axs[3].set_ylabel(f'Cashflow\n($/h)')
  axs[3].set_xlabel('Time (h)')
  axs[0].plot(time, res['steam_src'], 'o-', label='Steam source', markersize=4, linewidth=1)
  axs[0].plot(time, res['elec_gen_s'], 'o-', label='Elec generator steam production', markersize=4, linewidth=1)
  axs[0].legend(fontsize='small')
  axs[1].plot(time, res['steam_storage_c'], 'o-', label='Steam storage charge', markersize=4, linewidth=1)
  axs[1].plot(time, res['steam_storage_d'], 'o-', label='Steam storage discharge', markersize=4, linewidth=1)
  ax_1_rh.plot(time, res['steam_storage_l'], 'o-', label='Steam storage level', color='m', markersize=4, linewidth=1)
  axs[1].legend(loc="upper left", bbox_to_anchor=(0.2, 0.9), fontsize='small')
  ax_1_rh.legend(loc="lower right", fontsize='small')
  axs[2].plot(time, res['elec_gen_e'], 'o-', label='Elec generator elec production', markersize=4, linewidth=1)
  axs[2].plot(time, res['elec_sink'], 'o-', label='Elec sink', markersize=4, linewidth=1)
  axs[2].legend(fontsize='small')
  axs[3].plot(time, res['opex'], 'o-', label='Expenditures', markersize=4, linewidth=1)
  axs[3].plot(time, res['sales'], 'o-', label='Sales', markersize=4, linewidth=1)
  axs[3].plot(time, res['objective'], 'o-', label='Profit', markersize=4, linewidth=1)
...
def print_solution(m):
  ...
  print('  storage initial:', storage_initial.value)
  print('  dt:', dt)
